...
public class PlayerCharacter
{
	...
	PlayerCharacter(ClassType type, int playerNumber)
	{
		...
		switch(type)
		{
			case Knight:
				...
				// Skills
				this.skill1Name = "Reflect";
				this.skill1Desc = "Negates damage received and returns 80% of the damage to the original user as physical damage. Uses 2000 stamina."; 
				this.skill1Cost = 2000;
				
				this.skill2Name = "Slash";
				this.skill2Desc = "Does 350% physical damage to target, has a 10% chance of causing the bleed status for 3 turns. Uses 1500 stamina";
				this.skill2Cost = 1500;
				
				this.skill3Name = "Battle Cry";
				this.skill3Desc = "Gives berserk status for 3 turns. May be used  multiple times to restore duration. Uses 1000 stamina.";
				this.skill3Cost = 1000;
				
				this.skill4Name = "Guard Splitter";
				this.skill4Desc = "Does 450% physical damage to target and has causes the defense break status at a 70% rate for 3 turns. Uses 3000 stamina.";
			...
			case Mage:
				...
				this.strength = 20;
				this.defense = 50;
				this.magicDamage = 500;
				this.magicDefense = 200;
				this.avoid = 15.0;
				this.criticalRate = 20.0;
			...
			case Archer:
				...
				this.strength = 250;
				this.defense = 80;
				this.magicDamage = 250;
				this.magicDefense = 120;
				this.avoid = 25.0;
				this.criticalRate = 30.0;
	...
	public void endTurn()
	{
		...
		setBleedCounter(-1);
		setBerserkCounter(-1);
		setGuardBreakCounter(-1);
		setBurnCounter(-1);
		setMagicShellCounter(-1);
		setFocusCounter(-1);
		setBoundCounter(-1);
	}
	...
	protected int attack()
	{
		...
		if (getBoundCounter() == 0)
		{
			if (this.type == ClassType.Mage)
			{
